...
const headers = {'oai-authenticated-user-id':'local-gallery-test','oai-authenticated-user-email':'seedy@sites.test', Origin:base};
...
assert.equal((await call('/api/admin/photos',{headers:{...headers,'oai-authenticated-user-email':'intruder@example.com'}})).status,403);
